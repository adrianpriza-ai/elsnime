...
Elsnime is an educational prototype exploring hybrid single-page mobile architecture, custom WebView interfaces, async JavaScript-to-Java bridges, and Cronet TLS transport stacks. It is entirely non-commercial and provided free of charge; the developer does not monetize, advertise, or profit from its use.
...
All trademarks, registered brands, metadata, poster art, synopsis text, and video files indexed within this software remain the intellectual property of their respective creators, publishers, and legal copyright owners. Elsnime does not claim ownership or rights of any kind over the third-party assets its engine parses.

Copyright owners or licensing agents who wish to remove any content parsed by this app should contact the third-party providers hosting it. For developer inquiries, email [coreygit1@gmail.com](mailto:coreygit1@gmail.com). Once removed from the source, the content will stop displaying in this client.
...
We strongly encourage supporting the official anime industry: purchase official merchandise, subscribe to legitimate streaming services, and buy physical Blu-rays or digital copies where available in your country.
